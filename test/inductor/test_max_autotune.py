...
def benchmark_choice(benchmark_request, aten_time, triton_time):
    if isinstance(benchmark_request, ExternKernelBenchmarkRequest):
        return aten_time
    elif isinstance(benchmark_request, TritonBenchmarkRequest):
        return triton_time
    else:
        return float("inf")
...
def mock_benchmark_choice_wrapper(aten_time, triton_time):
    return functools.partial(
        benchmark_choice, aten_time=aten_time, triton_time=triton_time
    )
